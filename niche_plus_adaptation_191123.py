...
# =============================================================================
    ...
    #new adaptation section
    if current_time_step%time_of_adaptation: #only adapt (shift its niche one place) each 100 time steps 
        for plant in population: 
            
            
            adapt(environmental_niche[plant.x][plant.y],plant.niche) #this will check the niche in the
            #position of the plant, i.e. island, for now only one and only an homogeneous niche in the 
            #island. so the same value but it can change.
