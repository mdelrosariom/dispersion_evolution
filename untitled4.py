...
class Metapopulation:
    ...
    def initialize_pop(self):
        ...
        for n in range(startpop):            
            ...
            genome_ini = species[rnd.randint(0,3)]
    ...
    def a_day_in_the_life(self):
        ...
        for indiv in oldpop:   
            ...
            if indiv.x != 0 and indiv.y != 0: 
                ...
                if mainland_island[indiv.x-1, indiv.y-1] == 0 or indiv.age >2:  #All the individuals that fall into the sea end up dead.
                    indiv.state = "dead"    
            if indiv.state == "dead": 
        ...
        for i in oldpop: 
            ...
            #print("position,", i.x, i.y)
            print("age", i.age)
            #print("this shit,", mainland_island[i.x-1, i.y-1])
            #if mainland_island[indiv.x-1, indiv.y-1] == 0.0: 
             #   print("ok")
