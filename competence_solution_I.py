...
13. plants have as an atribute competitive ability. integer between 1 and 50, line 114
    ...
    for plant_1 in population: 
       ...
       # winner = None  # Initialize winner
        ...
        if len(same_place) > 1: # Step 1: Make a list with all the values of competitive ability of the plants in that position  
            ...
            for plant in same_place:
                comp_ab_values.append(plant.comp_ab)
                
            #step 2: determine who is the best competitor 
            best = max(comp_ab_values)
           
            #step 3, chose the plant with the best competitive ability
            for best_comp in same_place: 
